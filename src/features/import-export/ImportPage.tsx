...
export function ImportPage({
  ...
  async function handleFile(
    ...
    if (!Array.isArray(parsed)) {
      setPreview({
        parseError:
          "Top-level JSON must be an array of question objects.",
        valid: [],
        invalid: [],
        dupInFile: [],
        existingIds: [],
  ...
  async function commitImport() {
    ...
    await Store.createQuestionSet(
      setName,
      preview.valid.map((q) => q.id)
    );
    ...
    <div className="fade-in flex flex-col gap-6 max-w-3xl">
      <div>
        ...
        <div className="text-[13px] text-textMuted mt-0.5">
          Upload a JSON array conforming to the Question Generation Standard.
        </div>
      </div>
      ...
      {!preview && (
        ...
        >
          ...
          <div className="text-[13px] text-textMuted mb-3">
            Select a .json question bank file
          </div>
      ...
      {result && (
        ...
        >
          ...
          <div className="text-[12.5px] mt-1.5 text-textMuted">
            ...
            {result.skipped} skipped — saved as a set. See it under{" "}
            <b>Sets</b> in the sidebar.
          </div>
        </div>
      )}
        ...
        <div className="card p-4">
          ...
          <div className="mb-3.5">
            ...
            <input
              ...
              placeholder="e.g. Snowflake Architecture Batch 1"
            />

            <div className="text-[11.5px] text-textDim mt-1">
              This batch will be saved as a set you can browse and solve as its own queue, in upload order.
            </div>
          </div>
          ...
          <div className="text-[12.5px] mb-3">
            ...
            {Object.entries(preview.cats).map(
              ([c, n]) => (
                <div
                  key={c}
      ...
      <div className="card p-4">
        ...
        <div className="text-[12.5px] text-textMuted mb-3">
          Browser storage can be cleared unexpectedly — export regularly.
        </div>
      ...
      <div className="card p-4">
        ...
        <div className="text-[12.5px] text-textMuted mb-3">
          Restore a full backup exported from this application.
        </div>
